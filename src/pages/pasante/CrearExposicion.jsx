...
export const Crear = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!nombre || !descripcion || !imagenFile || !audioFile) {
      setError(
        "Todos los campos (nombre, descripción, imagen y audio) son obligatorios."
      );
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/exposiciones/crearExposicion`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div>
      <h1 className="font-black text-4xl text-gray-500">
        Crear Publicación para el Museo
      </h1>
      <hr className="my-4 border-gray-300" />
      <p className="mb-8">
        Añade una nueva pieza a la colección con su imagen y audioguía.
      </p>
