...
import { FaBookOpen, FaChalkboardTeacher, FaMapMarkerAlt, FaClock, FaPhone, FaEnvelope, FaArrowRight, FaDonate, FaCalendarAlt, FaUserPlus } from "react-icons/fa";
...
export const Home = () => {
    return (
        <>
            ...
            <header className="container mx-auto py-6 md:flex justify-between items-center px-6 sticky top-0 bg-white shadow-md z-50">
                ...
                <nav className='mt-4 md:mt-0'>
                    <ul className='flex gap-6 text-lg font-semibold text-teal-700'>
                        <li><a href="#inicio" className='hover:text-green-800 transition-colors duration-300'>Inicio</a></li>
                        <li><a href="#sobre-nosotros" className='hover:text-green-800 transition-colors duration-300'>Nosotros</a></li>
                        <li><a href="#servicios" className='hover:text-green-800 transition-colors duration-300'>Servicios</a></li>
                        <li><a href="#contacto" className='hover:text-green-800 transition-colors duration-300'>Contacto</a></li>
                        <li>
                            <Link to="/login" className='bg-teal-800 text-white px-5 py-2 rounded-lg hover:bg-teal-700 transition-colors'>
                                Iniciar Sesión
                            </Link>
                        </li>
                    </ul>
            ...
            {/* HERO SECTION */}
            <main id="inicio" className='bg-green-50 text-center py-14 px-6 md:text-left md:flex justify-between items-center gap-10'>
                <div className='md:w-3/5'>
                    <h1 className='text-5xl md:text-6xl font-extrabold text-teal-800 uppercase flex flex-col md:flex-row items-center gap-6 justify-center md:justify-start'>
                        ...
                        <img src={museo} alt="Logo Museo" className="h-36 w-auto inline-block md:ml-6" />
                    </h1>
                    ...
                    <p className='text-lg my-4 text-gray-700'>
                        Exposiciones permanentes, visitas guiadas, talleres educativos y más...
                    </p>
            ...
            <section id="sobre-nosotros" className='container mx-auto px-4 py-16'>
                <div className="text-center my-14 relative">
                    <h2 className="font-bold text-4xl inline-block bg-white px-6 relative z-10 text-teal-800 tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>
                        SOBRE NOSOTROS
                    </h2>
                ...
                <div className='my-10 flex flex-col gap-10 items-center sm:flex-row sm:justify-around sm:items-center'>
                    <div className='px-10 sm:w-3/4 text-center sm:text-left leading-relaxed text-lg'>
                        <p className='mb-6 text-gray-800'>
                            El Museo Gustavo Orcés es un espacio dedicado a la ciencia y la historia natural del Ecuador. 
                            Nuestro objetivo es educar, inspirar y conectar a los visitantes con la riqueza biológica y 
                            paleontológica del país a través de experiencias inmersivas y actividades didácticas.
                        </p>
            ...
            <section className='bg-green-50 py-16'>
                <div className='container mx-auto px-4'>
                    <div className="text-center my-14 relative">
                        <h2 className="font-bold text-4xl inline-block bg-green-50 px-6 relative z-10 text-teal-800 tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>
                            INFORMACIÓN DEL MUSEO
                        </h2>
                        <div className="absolute left-1/2 transform -translate-x-1/2 top-1/2 w-3/4 border-t-4 border-teal-700 z-0"></div>
                    </div>
                    ...
                    <div className='grid md:grid-cols-3 gap-8 max-w-5xl mx-auto'>
                        ...
                        <div className='text-center bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300'>
                            ...
                            <h3 className='font-bold text-xl mb-3 text-teal-800'>Ubicación</h3>
            ...
            <section id="servicios" className='container mx-auto px-4 py-16'>
                ...
                <div className='grid md:grid-cols-3 gap-8'>
                    ...
                    <div className="text-center shadow-lg hover:shadow-2xl transition-shadow duration-300 p-8 bg-green-50 rounded-xl">
                        ...
                        <h4 className="text-2xl font-bold text-teal-700 mb-4">Visitas Grupales</h4>
                        <p className="text-gray-700 mb-4">
                            Para grupos de 2 a 25 personas. Ideal para instituciones educativas.
                        </p>
                    ...
                    <div className="text-center shadow-lg hover:shadow-2xl transition-shadow duration-300 p-8 bg-green-50 rounded-xl">
                        ...
                        <h4 className="text-2xl font-bold text-teal-700 mb-4">Visitas Individuales</h4>
                        <p className="text-gray-700 mb-4">
                    ...
                    <div className="text-center shadow-lg hover:shadow-2xl transition-shadow duration-300 p-8 bg-green-50 rounded-xl">
                        ...
                        <h4 className="text-2xl font-bold text-teal-700 mb-4">Acceso Personal</h4>
                        <p className="text-gray-700 mb-4">
            ...
            {/* DONACIONES */}
            <section id="donaciones" className='bg-gradient-to-br from-teal-50 to-green-100 py-16'>
                <div className='container mx-auto px-4'>
                    <div className="text-center my-14 relative">
                        <h2 className="font-bold text-4xl inline-block bg-gradient-to-br from-teal-50 to-green-100 px-6 relative z-10 text-teal-800 tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>
                            APOYA AL MUSEO
                        </h2>
                        <div className="absolute left-1/2 transform -translate-x-1/2 top-1/2 w-3/4 border-t-4 border-teal-700 z-0"></div>
                    </div>
                    ...
                    <div className='grid md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
                        ...
                        <div className='bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-8'>
                            ...
                            <p className='text-gray-600 text-center mb-6'>
                                Dona materiales, equipos o especímenes para nuestras colecciones.
                            </p>
                            <Link 
            ...
            {/* FOOTER */}
            <footer id="contacto" className='text-center bg-green-50 p-6 sm:px-20 sm:py-10 mt-20 rounded-tr-3xl rounded-tl-3xl space-y-8'>
                
                <div className='flex justify-between items-center flex-wrap gap-6'>
                    <div className='text-3xl font-extrabold text-teal-800' style={{ fontFamily: "'Playfair Display', serif" }}>
                        Contáctanos
                    </div>
                ...
                <div className='text-left text-gray-800 font-medium space-y-2'>
                    <p className='flex items-center gap-2'>
                        ...
                        <span>Email: <span className='font-semibold'>info@museogustavorces.ec</span></span>
                    </p>
                    <p className='flex items-center gap-2'>
                        <FaPhone className='text-teal-700' />
                        <span>Teléfono: <span className='font-semibold'>02 123 4567</span></span>
                    </p>
                    <p className='flex items-center gap-2'>
